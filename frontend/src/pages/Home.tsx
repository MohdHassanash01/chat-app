...
<div className="absolute top-3 right-10 ">
  ...
  className="text-white bg-green-500 text-md font-semibold px-4 rounded-lg cursor-pointer py-1 hover:scale-104 transition-all duration-300 transform">Log out</button>
</div>
